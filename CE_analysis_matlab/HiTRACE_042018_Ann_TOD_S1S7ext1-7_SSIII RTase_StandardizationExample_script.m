...
% save save_HiTRACE_042018_Ann_TOD_S1S7ext1-7_SSIII_RTase_StandardizationExample.mat

%setting modifier types.  Apparently the data for each modifier are
%repeated (could be non-diluted vs. diluted data)
data_type = {'nomod','SHAPE','nomod','ddATP','ddCTP','ddGTP','ddTTP'};
...
goodpos = [9:143];
filename = 'ETERNA_TOD_StemExtension1M7.rdat';
...
figure(2); clf; r = show_rdat( 'ETERNA_TOD_StemExtension1M7.rdat' );
